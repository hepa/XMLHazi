                ...
                <c:forEach var="m" items="${messages}">                
                    <c:if test="${m.read}">
                        <tr>                    
                            ...
                            <td><a href="messageDetails.jsp?id=${m.id}">${m.from.firstName} ${m.from.lastName}</a></td>
                    ...
                    <c:if test="${!m.read}">
                        <tr>
                            ...
                            <td><a href="messageDetails.jsp?id=${m.id}"><b>${m.from.firstName} ${m.from.lastName}</b></a></td>
