...
<div id="secondSubHeader">
    <!-- Buttons -->
    <c:choose>
        <c:when test="${my.account.number == 0}">
            <form method="post" action="/Neptun/teacher/addAccount.jsp" style="float: left; padding-right: 10px;">                
        ...
        <c:when test="${my.account.number != 0}">
            <form method="post" action="/Neptun/teacher/accountManagement.jsp?number=${my.account.number}" style="float: left; padding-right: 10px;">                
